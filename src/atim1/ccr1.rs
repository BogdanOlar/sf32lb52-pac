...
pub type CcrR = crate::FieldReader<u32>;
///Field `CCR` writer - Capture/Compare value
pub type CcrW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CCR1").field("ccr", &self.ccr()).finish()
    }
}
impl W {
    ///Bits 0:31 - Capture/Compare value
    #[inline(always)]
    pub fn ccr(&mut self) -> CcrW<CCR1rs> {
        CcrW::new(self, 0)
    }
}
