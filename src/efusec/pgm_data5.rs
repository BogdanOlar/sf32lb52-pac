...
pub type R = crate::R<PGM_DATA5rs>;
///Register `PGM_DATA5` writer
pub type W = crate::W<PGM_DATA5rs>;
///Field `DATA` reader -
...
impl W {
    ///Bits 0:31
    #[inline(always)]
    pub fn data(&mut self) -> DataW<PGM_DATA5rs> {
        DataW::new(self, 0)
    }
}
///Program Data5
...
pub struct PGM_DATA5rs;
impl crate::RegisterSpec for PGM_DATA5rs {
    type Ux = u32;
}
///`read()` method returns [`pgm_data5::R`](R) reader structure
impl crate::Readable for PGM_DATA5rs {}
///`write(|w| ..)` method takes [`pgm_data5::W`](W) writer structure
impl crate::Writable for PGM_DATA5rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PGM_DATA5 to value 0
impl crate::Resettable for PGM_DATA5rs {
