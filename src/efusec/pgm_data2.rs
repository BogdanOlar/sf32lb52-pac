...
pub type R = crate::R<PGM_DATA2rs>;
///Register `PGM_DATA2` writer
pub type W = crate::W<PGM_DATA2rs>;
///Field `DATA` reader -
...
impl W {
    ///Bits 0:31
    #[inline(always)]
    pub fn data(&mut self) -> DataW<PGM_DATA2rs> {
        DataW::new(self, 0)
    }
}
///Program Data2
...
pub struct PGM_DATA2rs;
impl crate::RegisterSpec for PGM_DATA2rs {
    type Ux = u32;
}
///`read()` method returns [`pgm_data2::R`](R) reader structure
impl crate::Readable for PGM_DATA2rs {}
///`write(|w| ..)` method takes [`pgm_data2::W`](W) writer structure
impl crate::Writable for PGM_DATA2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PGM_DATA2 to value 0
impl crate::Resettable for PGM_DATA2rs {
