...
pub type R = crate::R<PGM_DATA3rs>;
///Register `PGM_DATA3` writer
pub type W = crate::W<PGM_DATA3rs>;
///Field `DATA` reader -
...
impl W {
    ///Bits 0:31
    #[inline(always)]
    pub fn data(&mut self) -> DataW<PGM_DATA3rs> {
        DataW::new(self, 0)
    }
}
///Program Data3
...
pub struct PGM_DATA3rs;
impl crate::RegisterSpec for PGM_DATA3rs {
    type Ux = u32;
}
///`read()` method returns [`pgm_data3::R`](R) reader structure
impl crate::Readable for PGM_DATA3rs {}
///`write(|w| ..)` method takes [`pgm_data3::W`](W) writer structure
impl crate::Writable for PGM_DATA3rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PGM_DATA3 to value 0
impl crate::Resettable for PGM_DATA3rs {
