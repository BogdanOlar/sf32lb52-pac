...
pub type R = crate::R<PGM_DATA4rs>;
///Register `PGM_DATA4` writer
pub type W = crate::W<PGM_DATA4rs>;
///Field `DATA` reader -
...
impl W {
    ///Bits 0:31
    #[inline(always)]
    pub fn data(&mut self) -> DataW<PGM_DATA4rs> {
        DataW::new(self, 0)
    }
}
///Program Data4
...
pub struct PGM_DATA4rs;
impl crate::RegisterSpec for PGM_DATA4rs {
    type Ux = u32;
}
///`read()` method returns [`pgm_data4::R`](R) reader structure
impl crate::Readable for PGM_DATA4rs {}
///`write(|w| ..)` method takes [`pgm_data4::W`](W) writer structure
impl crate::Writable for PGM_DATA4rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PGM_DATA4 to value 0
impl crate::Resettable for PGM_DATA4rs {
