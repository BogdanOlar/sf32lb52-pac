///Register `GPTIM1_PINR` reader
pub type R = crate::R<GPTIM1_PINRrs>;
///Register `GPTIM1_PINR` writer
pub type W = crate::W<GPTIM1_PINRrs>;
...
impl W {
    ///Bits 0:5 - Connect function pin to selected IO(PA). 0 to 44 for PA00 to PA44. Other values for floating.
    #[inline(always)]
    pub fn ch1_pin(&mut self) -> Ch1PinW<GPTIM1_PINRrs> {
        Ch1PinW::new(self, 0)
    }
    ///Bits 6:7
    #[inline(always)]
    pub fn rsvd4(&mut self) -> Rsvd4W<GPTIM1_PINRrs> {
        Rsvd4W::new(self, 6)
    }
    ///Bits 8:13 - Connect function pin to selected IO(PA). 0 to 44 for PA00 to PA44. Other values for floating.
    #[inline(always)]
    pub fn ch2_pin(&mut self) -> Ch2PinW<GPTIM1_PINRrs> {
        Ch2PinW::new(self, 8)
    }
    ///Bits 14:15
    #[inline(always)]
    pub fn rsvd3(&mut self) -> Rsvd3W<GPTIM1_PINRrs> {
        Rsvd3W::new(self, 14)
    }
    ///Bits 16:21 - Connect function pin to selected IO(PA). 0 to 44 for PA00 to PA44. Other values for floating.
    #[inline(always)]
    pub fn ch3_pin(&mut self) -> Ch3PinW<GPTIM1_PINRrs> {
        Ch3PinW::new(self, 16)
    }
    ///Bits 22:23
    #[inline(always)]
    pub fn rsvd2(&mut self) -> Rsvd2W<GPTIM1_PINRrs> {
        Rsvd2W::new(self, 22)
    }
    ///Bits 24:29 - Connect function pin to selected IO(PA). 0 to 44 for PA00 to PA44. Other values for floating.
    #[inline(always)]
    pub fn ch4_pin(&mut self) -> Ch4PinW<GPTIM1_PINRrs> {
        Ch4PinW::new(self, 24)
    }
    ///Bits 30:31
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<GPTIM1_PINRrs> {
        RsvdW::new(self, 30)
    }
}
///GPTIM1 Pin Register
///
///You can [`read`](crate::Reg::read) this register and get [`gptim1_pinr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gptim1_pinr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct GPTIM1_PINRrs;
impl crate::RegisterSpec for GPTIM1_PINRrs {
    type Ux = u32;
}
///`read()` method returns [`gptim1_pinr::R`](R) reader structure
impl crate::Readable for GPTIM1_PINRrs {}
///`write(|w| ..)` method takes [`gptim1_pinr::W`](W) writer structure
impl crate::Writable for GPTIM1_PINRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPTIM1_PINR to value 0
impl crate::Resettable for GPTIM1_PINRrs {
