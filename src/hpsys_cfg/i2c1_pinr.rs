///Register `I2C1_PINR` reader
pub type R = crate::R<I2C1_PINRrs>;
///Register `I2C1_PINR` writer
pub type W = crate::W<I2C1_PINRrs>;
...
impl W {
    ///Bits 0:5 - Connect function pin to selected IO(PA). 0 to 44 for PA00 to PA44. Other values for floating.
    #[inline(always)]
    pub fn scl_pin(&mut self) -> SclPinW<I2C1_PINRrs> {
        SclPinW::new(self, 0)
    }
    ///Bits 6:7
    #[inline(always)]
    pub fn rsvd2(&mut self) -> Rsvd2W<I2C1_PINRrs> {
        Rsvd2W::new(self, 6)
    }
    ///Bits 8:13 - Connect function pin to selected IO(PA). 0 to 44 for PA00 to PA44. Other values for floating.
    #[inline(always)]
    pub fn sda_pin(&mut self) -> SdaPinW<I2C1_PINRrs> {
        SdaPinW::new(self, 8)
    }
    ///Bits 14:31
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<I2C1_PINRrs> {
        RsvdW::new(self, 14)
    }
}
///I2C1 Pin Register
///
///You can [`read`](crate::Reg::read) this register and get [`i2c1_pinr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c1_pinr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct I2C1_PINRrs;
impl crate::RegisterSpec for I2C1_PINRrs {
    type Ux = u32;
}
///`read()` method returns [`i2c1_pinr::R`](R) reader structure
impl crate::Readable for I2C1_PINRrs {}
///`write(|w| ..)` method takes [`i2c1_pinr::W`](W) writer structure
impl crate::Writable for I2C1_PINRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets I2C1_PINR to value 0
impl crate::Resettable for I2C1_PINRrs {
