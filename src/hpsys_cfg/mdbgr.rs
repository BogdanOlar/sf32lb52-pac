...
///Field `LS_RAM2` reader - reserved for debug
pub type LsRam2R = crate::BitReader;
///Field `LS_RAM2` writer - reserved for debug
pub type LsRam2W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn ls_ram2(&self) -> LsRam2R {
        LsRam2R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - reserved for debug
    #[inline(always)]
    pub fn ls_rom(&self) -> LsRomR {
        LsRomR::new(((self.bits >> 3) & 1) != 0)
    }
...
impl W {
    ...
    ///Bit 2 - reserved for debug
    #[inline(always)]
    pub fn ls_ram2(&mut self) -> LsRam2W<MDBGRrs> {
        LsRam2W::new(self, 2)
    }
    ///Bit 3 - reserved for debug
    #[inline(always)]
