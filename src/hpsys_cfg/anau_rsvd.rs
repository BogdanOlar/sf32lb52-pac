///Register `ANAU_RSVD` reader
pub type R = crate::R<ANAU_RSVDrs>;
///Register `ANAU_RSVD` writer
pub type W = crate::W<ANAU_RSVDrs>;
...
impl W {
    ///Bits 0:7 - reserved for debug
    #[inline(always)]
    pub fn reserve0(&mut self) -> Reserve0W<ANAU_RSVDrs> {
        Reserve0W::new(self, 0)
    }
    ///Bits 8:15 - reserved for debug
    #[inline(always)]
    pub fn reserve1(&mut self) -> Reserve1W<ANAU_RSVDrs> {
        Reserve1W::new(self, 8)
    }
    ///Bits 16:23 - reserved for debug
    #[inline(always)]
    pub fn reserve2(&mut self) -> Reserve2W<ANAU_RSVDrs> {
        Reserve2W::new(self, 16)
    }
    ///Bits 24:31 - reserved for debug
    #[inline(always)]
    pub fn reserve3(&mut self) -> Reserve3W<ANAU_RSVDrs> {
        Reserve3W::new(self, 24)
    }
}
///ANAU Reserve Register
///
///You can [`read`](crate::Reg::read) this register and get [`anau_rsvd::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`anau_rsvd::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct ANAU_RSVDrs;
impl crate::RegisterSpec for ANAU_RSVDrs {
    type Ux = u32;
}
///`read()` method returns [`anau_rsvd::R`](R) reader structure
impl crate::Readable for ANAU_RSVDrs {}
///`write(|w| ..)` method takes [`anau_rsvd::W`](W) writer structure
impl crate::Writable for ANAU_RSVDrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ANAU_RSVD to value 0
impl crate::Resettable for ANAU_RSVDrs {
