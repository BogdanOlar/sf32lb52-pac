///Register `USART2_PINR` reader
pub type R = crate::R<USART2_PINRrs>;
///Register `USART2_PINR` writer
pub type W = crate::W<USART2_PINRrs>;
...
impl W {
    ///Bits 0:5 - Connect function pin to selected IO(PA). 0 to 44 for PA00 to PA44. Other values for floating.
    #[inline(always)]
    pub fn txd_pin(&mut self) -> TxdPinW<USART2_PINRrs> {
        TxdPinW::new(self, 0)
    }
    ///Bits 6:7
    #[inline(always)]
    pub fn rsvd4(&mut self) -> Rsvd4W<USART2_PINRrs> {
        Rsvd4W::new(self, 6)
    }
    ///Bits 8:13 - Connect function pin to selected IO(PA). 0 to 44 for PA00 to PA44. Other values for floating.
    #[inline(always)]
    pub fn rxd_pin(&mut self) -> RxdPinW<USART2_PINRrs> {
        RxdPinW::new(self, 8)
    }
    ///Bits 14:15
    #[inline(always)]
    pub fn rsvd3(&mut self) -> Rsvd3W<USART2_PINRrs> {
        Rsvd3W::new(self, 14)
    }
    ///Bits 16:21 - Connect function pin to selected IO(PA). 0 to 44 for PA00 to PA44. Other values for floating.
    #[inline(always)]
    pub fn rts_pin(&mut self) -> RtsPinW<USART2_PINRrs> {
        RtsPinW::new(self, 16)
    }
    ///Bits 22:23
    #[inline(always)]
    pub fn rsvd2(&mut self) -> Rsvd2W<USART2_PINRrs> {
        Rsvd2W::new(self, 22)
    }
    ///Bits 24:29 - Connect function pin to selected IO(PA). 0 to 44 for PA00 to PA44. Other values for floating.
    #[inline(always)]
    pub fn cts_pin(&mut self) -> CtsPinW<USART2_PINRrs> {
        CtsPinW::new(self, 24)
    }
    ///Bits 30:31
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<USART2_PINRrs> {
        RsvdW::new(self, 30)
    }
}
///USART2 Pin Register
///
///You can [`read`](crate::Reg::read) this register and get [`usart2_pinr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`usart2_pinr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct USART2_PINRrs;
impl crate::RegisterSpec for USART2_PINRrs {
    type Ux = u32;
}
///`read()` method returns [`usart2_pinr::R`](R) reader structure
impl crate::Readable for USART2_PINRrs {}
///`write(|w| ..)` method takes [`usart2_pinr::W`](W) writer structure
impl crate::Writable for USART2_PINRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets USART2_PINR to value 0
impl crate::Resettable for USART2_PINRrs {
