///Register `DAC_CH1_CFG` reader
pub type R = crate::R<DAC_CH1_CFGrs>;
///Register `DAC_CH1_CFG` writer
pub type W = crate::W<DAC_CH1_CFGrs>;
...
impl W {
    ///Bit 0 - dac channel enable
    #[inline(always)]
    pub fn enable(&mut self) -> EnableW<DAC_CH1_CFGrs> {
        EnableW::new(self, 0)
    }
    ///Bit 1 - dac output mute, set 1 to mute the output
    #[inline(always)]
    pub fn dout_mute(&mut self) -> DoutMuteW<DAC_CH1_CFGrs> {
        DoutMuteW::new(self, 1)
    }
    ///Bits 2:3 - dem output mode 2'h0: no shift for dem output 2'h1: shift dem output incrementally 2'h2: shift dem output according to input 2'h3: reserved
    #[inline(always)]
    pub fn dem_mode(&mut self) -> DemModeW<DAC_CH1_CFGrs> {
        DemModeW::new(self, 2)
    }
    ///Bits 4:6 - dac input stb fifo cnt
    #[inline(always)]
    pub fn stb_fifo_cnt(&mut self) -> StbFifoCntW<DAC_CH1_CFGrs> {
        StbFifoCntW::new(self, 4)
    }
    ///Bit 7 - dma interface enable in apb mode 1: enable dac ch0 dma request interface 0: disable dac ch0 dma request interface
    #[inline(always)]
    pub fn dma_en(&mut self) -> DmaEnW<DAC_CH1_CFGrs> {
        DmaEnW::new(self, 7)
    }
    ///Bits 8:11 - dac rough volume control range from -36dB to 54dB step is 6dB 4'h0: -36dB 4'h1: -30dB ...... 4'h6: 0dB ...... 4'he: 48dB 4'hf: 54dB
    #[inline(always)]
    pub fn rough_vol(&mut self) -> RoughVolW<DAC_CH1_CFGrs> {
        RoughVolW::new(self, 8)
    }
    ///Bits 12:15 - dac fine volume control range from 0dB to 6dB step is 0.5dB 4'h0: 0dB 4'h1: 0.5dB ...... 4'hb: 5.5dB 4'hc, 4'hd, 4'he, 4'hf: mute
    #[inline(always)]
    pub fn fine_vol(&mut self) -> FineVolW<DAC_CH1_CFGrs> {
        FineVolW::new(self, 12)
    }
    ///Bit 16 - dac data format 1: 16-bit 0: 24-bit this bit only affect the data format accessed by apb interface. For 24-bit, every 24-bit data occupied 32-bit word. Bit\[31:24\]
    ///are zeros. For 16-bit mode, every 32-bit word contains two 16-bit audio data{D1, D0}
    #[inline(always)]
    pub fn data_format(&mut self) -> DataFormatW<DAC_CH1_CFGrs> {
        DataFormatW::new(self, 16)
    }
    ///Bits 17:25 - dac sinc filter gain
    #[inline(always)]
    pub fn sinc_gain(&mut self) -> SincGainW<DAC_CH1_CFGrs> {
        SincGainW::new(self, 17)
    }
    ///Bits 26:28 - sdm dither gain
    #[inline(always)]
    pub fn dither_gain(&mut self) -> DitherGainW<DAC_CH1_CFGrs> {
        DitherGainW::new(self, 26)
    }
    ///Bit 29 - sdm dither enable
    #[inline(always)]
    pub fn dither_en(&mut self) -> DitherEnW<DAC_CH1_CFGrs> {
        DitherEnW::new(self, 29)
    }
    ///Bit 30 - analog dac clock polarity
    #[inline(always)]
    pub fn clk_ana_pol(&mut self) -> ClkAnaPolW<DAC_CH1_CFGrs> {
        ClkAnaPolW::new(self, 30)
    }
    ///Bit 31
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<DAC_CH1_CFGrs> {
        RsvdW::new(self, 31)
    }
}
///
///
///You can [`read`](crate::Reg::read) this register and get [`dac_ch1_cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dac_ch1_cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct DAC_CH1_CFGrs;
impl crate::RegisterSpec for DAC_CH1_CFGrs {
    type Ux = u32;
}
///`read()` method returns [`dac_ch1_cfg::R`](R) reader structure
impl crate::Readable for DAC_CH1_CFGrs {}
///`write(|w| ..)` method takes [`dac_ch1_cfg::W`](W) writer structure
impl crate::Writable for DAC_CH1_CFGrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DAC_CH1_CFG to value 0
impl crate::Resettable for DAC_CH1_CFGrs {
