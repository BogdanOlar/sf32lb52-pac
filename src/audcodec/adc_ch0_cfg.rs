///Register `ADC_CH0_CFG` reader
pub type R = crate::R<ADC_CH0_CFGrs>;
///Register `ADC_CH0_CFG` writer
pub type W = crate::W<ADC_CH0_CFGrs>;
...
impl W {
    ///Bit 0 - adc channel enable
    #[inline(always)]
    pub fn enable(&mut self) -> EnableW<ADC_CH0_CFGrs> {
        EnableW::new(self, 0)
    }
    ///Bit 1 - high-pass filter bypass
    #[inline(always)]
    pub fn hpf_bypass(&mut self) -> HpfBypassW<ADC_CH0_CFGrs> {
        HpfBypassW::new(self, 1)
    }
    ///Bits 2:5 - high-pass filter coefficient
    #[inline(always)]
    pub fn hpf_coef(&mut self) -> HpfCoefW<ADC_CH0_CFGrs> {
        HpfCoefW::new(self, 2)
    }
    ///Bit 6 - adc strobe inverter
    #[inline(always)]
    pub fn stb_inv(&mut self) -> StbInvW<ADC_CH0_CFGrs> {
        StbInvW::new(self, 6)
    }
    ///Bit 7 - dma interface enable in apb mode and raw data apb mode 1: enable adc ch0 dma request interface 0: disable adc ch0 dma request interface
    #[inline(always)]
    pub fn dma_en(&mut self) -> DmaEnW<ADC_CH0_CFGrs> {
        DmaEnW::new(self, 7)
    }
    ///Bits 8:11 - adc rough volume control range from -60dB to 30dB step is 6dB 4'h0: -60dB 4'h1: -54dB ...... 4'ha: 0dB ...... 4'he: 24dB 4'hf: 30dB
    #[inline(always)]
    pub fn rough_vol(&mut self) -> RoughVolW<ADC_CH0_CFGrs> {
        RoughVolW::new(self, 8)
    }
    ///Bits 12:15 - adc fine volume control range from 0dB to 6dB step is 0.5dB 4'h0: 0dB 4'h1: 0.5dB ...... 4'hb: 5.5dB 4'hc, 4'hd, 4'he, 4'hf: mute
    #[inline(always)]
    pub fn fine_vol(&mut self) -> FineVolW<ADC_CH0_CFGrs> {
        FineVolW::new(self, 12)
    }
    ///Bit 16 - adc data format 1: 16-bit 0: 24-bit this bit only affect the data format accessed by apb interface. For 24-bit, every 24-bit data occupied 32-bit word. Bit\[31:24\]
    ///are zeros. For 16-bit mode, every 32-bit word contains two 16-bit audio data{D1, D0}
    #[inline(always)]
    pub fn data_format(&mut self) -> DataFormatW<ADC_CH0_CFGrs> {
        DataFormatW::new(self, 16)
    }
    ///Bit 17 - adc saturation detect
    #[inline(always)]
    pub fn sat_det_en(&mut self) -> SatDetEnW<ADC_CH0_CFGrs> {
        SatDetEnW::new(self, 17)
    }
    ///Bits 18:19 - adc saturation detect pattern length 2'b00: 16 2'b01: 24 2'b10: 32 2'b11: 48
    #[inline(always)]
    pub fn sat_det_len(&mut self) -> SatDetLenW<ADC_CH0_CFGrs> {
        SatDetLenW::new(self, 18)
    }
    ///Bits 20:31
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<ADC_CH0_CFGrs> {
        RsvdW::new(self, 20)
    }
}
///
///
///You can [`read`](crate::Reg::read) this register and get [`adc_ch0_cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adc_ch0_cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct ADC_CH0_CFGrs;
impl crate::RegisterSpec for ADC_CH0_CFGrs {
    type Ux = u32;
}
///`read()` method returns [`adc_ch0_cfg::R`](R) reader structure
impl crate::Readable for ADC_CH0_CFGrs {}
///`write(|w| ..)` method takes [`adc_ch0_cfg::W`](W) writer structure
impl crate::Writable for ADC_CH0_CFGrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ADC_CH0_CFG to value 0
impl crate::Resettable for ADC_CH0_CFGrs {
