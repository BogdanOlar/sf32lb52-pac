///Register `DAC1_CFG` reader
pub type R = crate::R<DAC1_CFGrs>;
///Register `DAC1_CFG` writer
pub type W = crate::W<DAC1_CFGrs>;
...
impl W {
    ///Bit 0 - enable os dac
    #[inline(always)]
    pub fn en_os_dac(&mut self) -> EnOsDacW<DAC1_CFGrs> {
        EnOsDacW::new(self, 0)
    }
    ///Bits 1:7 - os dac
    #[inline(always)]
    pub fn os_dac(&mut self) -> OsDacW<DAC1_CFGrs> {
        OsDacW::new(self, 1)
    }
    ///Bits 8:11 - dac gain
    #[inline(always)]
    pub fn gain(&mut self) -> GainW<DAC1_CFGrs> {
        GainW::new(self, 8)
    }
    ///Bit 12 - dac short switch
    #[inline(always)]
    pub fn sr(&mut self) -> SrW<DAC1_CFGrs> {
        SrW::new(self, 12)
    }
    ///Bit 13 - dac clk polarity
    #[inline(always)]
    pub fn pol_clk(&mut self) -> PolClkW<DAC1_CFGrs> {
        PolClkW::new(self, 13)
    }
    ///Bit 14 - 0: 3.3V sup, 1: 1.8V supply
    #[inline(always)]
    pub fn lp_mode(&mut self) -> LpModeW<DAC1_CFGrs> {
        LpModeW::new(self, 14)
    }
    ///Bits 15:17 - select vcm
    #[inline(always)]
    pub fn sel_vcm(&mut self) -> SelVcmW<DAC1_CFGrs> {
        SelVcmW::new(self, 15)
    }
    ///Bits 18:19 - bias mode
    #[inline(always)]
    pub fn bm(&mut self) -> BmW<DAC1_CFGrs> {
        BmW::new(self, 18)
    }
    ///Bit 20 - enable chop
    #[inline(always)]
    pub fn en_chop(&mut self) -> EnChopW<DAC1_CFGrs> {
        EnChopW::new(self, 20)
    }
    ///Bit 21 - enable amp
    #[inline(always)]
    pub fn en_amp(&mut self) -> EnAmpW<DAC1_CFGrs> {
        EnAmpW::new(self, 21)
    }
    ///Bit 22 - enable vcm
    #[inline(always)]
    pub fn en_vcm(&mut self) -> EnVcmW<DAC1_CFGrs> {
        EnVcmW::new(self, 22)
    }
    ///Bit 23 - enable dac
    #[inline(always)]
    pub fn en_dac(&mut self) -> EnDacW<DAC1_CFGrs> {
        EnDacW::new(self, 23)
    }
    ///Bits 24:25 - select Vstart
    #[inline(always)]
...
pub struct DAC1_CFGrs;
impl crate::RegisterSpec for DAC1_CFGrs {
    type Ux = u32;
}
///`read()` method returns [`dac1_cfg::R`](R) reader structure
impl crate::Readable for DAC1_CFGrs {}
///`write(|w| ..)` method takes [`dac1_cfg::W`](W) writer structure
impl crate::Writable for DAC1_CFGrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DAC1_CFG to value 0
impl crate::Resettable for DAC1_CFGrs {
