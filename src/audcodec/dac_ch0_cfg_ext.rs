///Register `DAC_CH0_CFG_EXT` reader
pub type R = crate::R<DAC_CH0_CFG_EXTrs>;
///Register `DAC_CH0_CFG_EXT` writer
pub type W = crate::W<DAC_CH0_CFG_EXTrs>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DAC_CH0_CFG_EXT")
...
impl W {
    ///Bit 0 - volume ramp enable
    #[inline(always)]
    pub fn ramp_en(&mut self) -> RampEnW<DAC_CH0_CFG_EXTrs> {
        RampEnW::new(self, 0)
    }
    ///Bit 1 - volume ramp mode: 1: slowly ramp to target volume. Step is 0.5db 0: directly ramp to target volume.
    #[inline(always)]
    pub fn ramp_mode(&mut self) -> RampModeW<DAC_CH0_CFG_EXTrs> {
        RampModeW::new(self, 1)
    }
    ///Bit 2 - enable volume adjustment during 0 volume cross.
    #[inline(always)]
    pub fn zero_adjust_en(&mut self) -> ZeroAdjustEnW<DAC_CH0_CFG_EXTrs> {
        ZeroAdjustEnW::new(self, 2)
    }
    ///Bits 3:6 - volume ramp interval.
    #[inline(always)]
    pub fn ramp_interval(&mut self) -> RampIntervalW<DAC_CH0_CFG_EXTrs> {
        RampIntervalW::new(self, 3)
    }
    ///Bits 7:8 - ramp module status
    #[inline(always)]
    pub fn ramp_stat(&mut self) -> RampStatW<DAC_CH0_CFG_EXTrs> {
        RampStatW::new(self, 7)
    }
    ///Bits 9:31
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<DAC_CH0_CFG_EXTrs> {
        RsvdW::new(self, 9)
    }
}
///
///
///You can [`read`](crate::Reg::read) this register and get [`dac_ch0_cfg_ext::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dac_ch0_cfg_ext::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct DAC_CH0_CFG_EXTrs;
impl crate::RegisterSpec for DAC_CH0_CFG_EXTrs {
    type Ux = u32;
}
///`read()` method returns [`dac_ch0_cfg_ext::R`](R) reader structure
impl crate::Readable for DAC_CH0_CFG_EXTrs {}
///`write(|w| ..)` method takes [`dac_ch0_cfg_ext::W`](W) writer structure
impl crate::Writable for DAC_CH0_CFG_EXTrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DAC_CH0_CFG_EXT to value 0
impl crate::Resettable for DAC_CH0_CFG_EXTrs {
