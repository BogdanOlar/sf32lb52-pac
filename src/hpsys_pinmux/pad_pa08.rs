///Register `PAD_PA08` reader
pub type R = crate::R<PAD_PA08rs>;
///Register `PAD_PA08` writer
pub type W = crate::W<PAD_PA08rs>;
...
impl W {
    ///Bits 0:3 - Function Select
    #[inline(always)]
    pub fn fsel(&mut self) -> FselW<PAD_PA08rs> {
        FselW::new(self, 0)
    }
    ///Bit 4 - Pull Enable. Logic HIGH enables week pull device
    #[inline(always)]
    pub fn pe(&mut self) -> PeW<PAD_PA08rs> {
        PeW::new(self, 4)
    }
    ///Bit 5 - Pull Select. Logic HIGH selects pull-up, logic LOW select pull-down
    #[inline(always)]
    pub fn ps(&mut self) -> PsW<PAD_PA08rs> {
        PsW::new(self, 5)
    }
    ///Bit 6 - Input Enable. Logic HIGH enables the input buffer
    #[inline(always)]
    pub fn ie(&mut self) -> IeW<PAD_PA08rs> {
        IeW::new(self, 6)
    }
    ///Bit 7 - Input Select. Logic LOW selects CMOS input, logic HIGH selects Schmitt input
    #[inline(always)]
    pub fn is(&mut self) -> IsW<PAD_PA08rs> {
        IsW::new(self, 7)
    }
    ///Bit 8 - Slew Rate. Logic HIGH selects slow slew rate, logic LOW selects fast slew rate
    #[inline(always)]
    pub fn sr(&mut self) -> SrW<PAD_PA08rs> {
        SrW::new(self, 8)
    }
    ///Bit 9 - Drive Select 0. Used to select output drive strength
    #[inline(always)]
    pub fn ds0(&mut self) -> Ds0W<PAD_PA08rs> {
        Ds0W::new(self, 9)
    }
    ///Bit 10 - Drive Select 1. Used to select output drive strength
    #[inline(always)]
    pub fn ds1(&mut self) -> Ds1W<PAD_PA08rs> {
        Ds1W::new(self, 10)
    }
    ///Bit 11 - Reserved. Always set to logic LOW
    #[inline(always)]
    pub fn poe(&mut self) -> PoeW<PAD_PA08rs> {
        PoeW::new(self, 11)
    }
    ///Bits 12:31
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<PAD_PA08rs> {
        RsvdW::new(self, 12)
    }
}
///
///
///You can [`read`](crate::Reg::read) this register and get [`pad_pa08::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pad_pa08::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct PAD_PA08rs;
impl crate::RegisterSpec for PAD_PA08rs {
    type Ux = u32;
}
///`read()` method returns [`pad_pa08::R`](R) reader structure
impl crate::Readable for PAD_PA08rs {}
///`write(|w| ..)` method takes [`pad_pa08::W`](W) writer structure
impl crate::Writable for PAD_PA08rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PAD_PA08 to value 0
impl crate::Resettable for PAD_PA08rs {
