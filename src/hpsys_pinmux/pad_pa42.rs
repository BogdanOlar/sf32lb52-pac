///Register `PAD_PA42` reader
pub type R = crate::R<PAD_PA42rs>;
///Register `PAD_PA42` writer
pub type W = crate::W<PAD_PA42rs>;
...
impl W {
    ///Bits 0:3 - Function Select
    #[inline(always)]
    pub fn fsel(&mut self) -> FselW<PAD_PA42rs> {
        FselW::new(self, 0)
    }
    ///Bit 4 - Pull Enable. Logic HIGH enables week pull device
    #[inline(always)]
    pub fn pe(&mut self) -> PeW<PAD_PA42rs> {
        PeW::new(self, 4)
    }
    ///Bit 5 - Pull Select. Logic HIGH selects pull-up, logic LOW select pull-down
    #[inline(always)]
    pub fn ps(&mut self) -> PsW<PAD_PA42rs> {
        PsW::new(self, 5)
    }
    ///Bit 6 - Input Enable. Logic HIGH enables the input buffer
    #[inline(always)]
    pub fn ie(&mut self) -> IeW<PAD_PA42rs> {
        IeW::new(self, 6)
    }
    ///Bit 7 - Input Select. Logic LOW selects CMOS input, logic HIGH selects Schmitt input
    #[inline(always)]
    pub fn is(&mut self) -> IsW<PAD_PA42rs> {
        IsW::new(self, 7)
    }
    ///Bit 8 - Mode Select. Logic LOW enables GPIO mode,logic HIGH enables I2C mode
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<PAD_PA42rs> {
        ModeW::new(self, 8)
    }
    ///Bit 9
    #[inline(always)]
    pub fn rsvd2(&mut self) -> Rsvd2W<PAD_PA42rs> {
        Rsvd2W::new(self, 9)
    }
    ///Bit 10 - Drive Select. Logic LOW selects 4mA drive,logic HIGH selects 20mA drive
    #[inline(always)]
    pub fn ds(&mut self) -> DsW<PAD_PA42rs> {
        DsW::new(self, 10)
    }
    ///Bit 11 - Reserved. Always set to logic LOW
    #[inline(always)]
    pub fn poe(&mut self) -> PoeW<PAD_PA42rs> {
        PoeW::new(self, 11)
    }
    ///Bits 12:31
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<PAD_PA42rs> {
        RsvdW::new(self, 12)
    }
}
///
///
///You can [`read`](crate::Reg::read) this register and get [`pad_pa42::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pad_pa42::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct PAD_PA42rs;
impl crate::RegisterSpec for PAD_PA42rs {
    type Ux = u32;
}
///`read()` method returns [`pad_pa42::R`](R) reader structure
impl crate::Readable for PAD_PA42rs {}
///`write(|w| ..)` method takes [`pad_pa42::W`](W) writer structure
impl crate::Writable for PAD_PA42rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PAD_PA42 to value 0
impl crate::Resettable for PAD_PA42rs {
