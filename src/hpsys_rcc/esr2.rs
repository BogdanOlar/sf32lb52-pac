///Register `ESR2` reader
pub type R = crate::R<ESR2rs>;
///Register `ESR2` writer
pub type W = crate::W<ESR2rs>;
///Field `GPIO1` reader - write 1 to set module enable, write 0 has no effect
pub type Gpio1R = crate::BitReader;
///Field `GPIO1` writer - write 1 to set module enable, write 0 has no effect
pub type Gpio1W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MPI1` reader - write 1 to set module enable, write 0 has no effect
pub type Mpi1R = crate::BitReader;
///Field `MPI1` writer - write 1 to set module enable, write 0 has no effect
pub type Mpi1W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MPI2` reader - write 1 to set module enable, write 0 has no effect
pub type Mpi2R = crate::BitReader;
///Field `MPI2` writer - write 1 to set module enable, write 0 has no effect
pub type Mpi2W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RSVD8` reader -
pub type Rsvd8R = crate::BitReader;
///Field `RSVD8` writer -
pub type Rsvd8W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SDMMC1` reader - write 1 to set module enable, write 0 has no effect
pub type Sdmmc1R = crate::BitReader;
///Field `SDMMC1` writer - write 1 to set module enable, write 0 has no effect
pub type Sdmmc1W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RSVD7` reader -
pub type Rsvd7R = crate::BitReader;
///Field `RSVD7` writer -
pub type Rsvd7W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USBC` reader - write 1 to set module enable, write 0 has no effect
pub type UsbcR = crate::BitReader;
///Field `USBC` writer - write 1 to set module enable, write 0 has no effect
pub type UsbcW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RSVD6` reader -
pub type Rsvd6R = crate::BitReader;
///Field `RSVD6` writer -
pub type Rsvd6W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2C3` reader - write 1 to set module enable, write 0 has no effect
pub type I2c3R = crate::BitReader;
///Field `I2C3` writer - write 1 to set module enable, write 0 has no effect
pub type I2c3W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ATIM1` reader - write 1 to set module enable, write 0 has no effect
pub type Atim1R = crate::BitReader;
///Field `ATIM1` writer - write 1 to set module enable, write 0 has no effect
...
///Field `USART3` reader - write 1 to set module enable, write 0 has no effect
pub type Usart3R = crate::BitReader;
///Field `USART3` writer - write 1 to set module enable, write 0 has no effect
...
///Field `AUDCODEC` reader - write 1 to set module enable, write 0 has no effect
pub type AudcodecR = crate::BitReader;
///Field `AUDCODEC` writer - write 1 to set module enable, write 0 has no effect
pub type AudcodecW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AUDPRC` reader - write 1 to set module enable, write 0 has no effect
pub type AudprcR = crate::BitReader;
///Field `AUDPRC` writer - write 1 to set module enable, write 0 has no effect
pub type AudprcW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RSVD3` reader -
pub type Rsvd3R = crate::BitReader;
///Field `RSVD3` writer -
pub type Rsvd3W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GPADC` reader - write 1 to set module enable, write 0 has no effect
pub type GpadcR = crate::BitReader;
///Field `GPADC` writer - write 1 to set module enable, write 0 has no effect
pub type GpadcW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TSEN` reader - write 1 to set module enable, write 0 has no effect
pub type TsenR = crate::BitReader;
///Field `TSEN` writer - write 1 to set module enable, write 0 has no effect
pub type TsenW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RSVD2` reader -
pub type Rsvd2R = crate::BitReader;
///Field `RSVD2` writer -
pub type Rsvd2W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2C4` reader - write 1 to set module enable, write 0 has no effect
pub type I2c4R = crate::BitReader;
///Field `I2C4` writer - write 1 to set module enable, write 0 has no effect
...
impl W {
    ///Bit 0 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn gpio1(&mut self) -> Gpio1W<ESR2rs> {
        Gpio1W::new(self, 0)
    }
    ///Bit 1 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn mpi1(&mut self) -> Mpi1W<ESR2rs> {
        Mpi1W::new(self, 1)
    }
    ///Bit 2 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn mpi2(&mut self) -> Mpi2W<ESR2rs> {
        Mpi2W::new(self, 2)
    }
    ///Bit 3
    #[inline(always)]
    pub fn rsvd8(&mut self) -> Rsvd8W<ESR2rs> {
        Rsvd8W::new(self, 3)
    }
    ///Bit 4 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn sdmmc1(&mut self) -> Sdmmc1W<ESR2rs> {
        Sdmmc1W::new(self, 4)
    }
    ///Bit 5
    #[inline(always)]
    pub fn rsvd7(&mut self) -> Rsvd7W<ESR2rs> {
        Rsvd7W::new(self, 5)
    }
    ///Bit 6 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn usbc(&mut self) -> UsbcW<ESR2rs> {
        UsbcW::new(self, 6)
    }
    ///Bit 7
    #[inline(always)]
    pub fn rsvd6(&mut self) -> Rsvd6W<ESR2rs> {
        Rsvd6W::new(self, 7)
    }
    ///Bit 8 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn i2c3(&mut self) -> I2c3W<ESR2rs> {
        I2c3W::new(self, 8)
    }
    ///Bit 9 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn atim1(&mut self) -> Atim1W<ESR2rs> {
        Atim1W::new(self, 9)
    }
    ///Bits 10:11
    #[inline(always)]
    pub fn rsvd5(&mut self) -> Rsvd5W<ESR2rs> {
        Rsvd5W::new(self, 10)
    }
    ///Bit 12 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn usart3(&mut self) -> Usart3W<ESR2rs> {
        Usart3W::new(self, 12)
    }
    ///Bits 13:18
    #[inline(always)]
    pub fn rsvd4(&mut self) -> Rsvd4W<ESR2rs> {
        Rsvd4W::new(self, 13)
    }
    ///Bit 19 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn audcodec(&mut self) -> AudcodecW<ESR2rs> {
        AudcodecW::new(self, 19)
    }
    ///Bit 20 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn audprc(&mut self) -> AudprcW<ESR2rs> {
        AudprcW::new(self, 20)
    }
    ///Bit 21
    #[inline(always)]
    pub fn rsvd3(&mut self) -> Rsvd3W<ESR2rs> {
        Rsvd3W::new(self, 21)
    }
    ///Bit 22 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn gpadc(&mut self) -> GpadcW<ESR2rs> {
        GpadcW::new(self, 22)
    }
    ///Bit 23 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn tsen(&mut self) -> TsenW<ESR2rs> {
        TsenW::new(self, 23)
    }
    ///Bit 24
    #[inline(always)]
    pub fn rsvd2(&mut self) -> Rsvd2W<ESR2rs> {
        Rsvd2W::new(self, 24)
    }
    ///Bit 25 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn i2c4(&mut self) -> I2c4W<ESR2rs> {
        I2c4W::new(self, 25)
    }
    ///Bits 26:31
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<ESR2rs> {
        RsvdW::new(self, 26)
    }
}
///Enable Set Register 2
///
///You can [`read`](crate::Reg::read) this register and get [`esr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`esr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct ESR2rs;
impl crate::RegisterSpec for ESR2rs {
    type Ux = u32;
}
///`read()` method returns [`esr2::R`](R) reader structure
impl crate::Readable for ESR2rs {}
///`write(|w| ..)` method takes [`esr2::W`](W) writer structure
impl crate::Writable for ESR2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ESR2 to value 0
impl crate::Resettable for ESR2rs {
