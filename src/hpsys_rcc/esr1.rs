...
///Field `DMAC1` reader - write 1 to set module enable, write 0 has no effect
pub type Dmac1R = crate::BitReader;
///Field `DMAC1` writer - write 1 to set module enable, write 0 has no effect
pub type Dmac1W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MAILBOX1` reader - write 1 to set module enable, write 0 has no effect
pub type Mailbox1R = crate::BitReader;
///Field `MAILBOX1` writer - write 1 to set module enable, write 0 has no effect
pub type Mailbox1W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PINMUX1` reader - write 1 to set module enable, write 0 has no effect
...
///Field `EZIP1` reader - write 1 to set module enable, write 0 has no effect
pub type Ezip1R = crate::BitReader;
///Field `EZIP1` writer - write 1 to set module enable, write 0 has no effect
pub type Ezip1W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EPIC` reader - write 1 to set module enable, write 0 has no effect
pub type EpicR = crate::BitReader;
///Field `EPIC` writer - write 1 to set module enable, write 0 has no effect
pub type EpicW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCDC1` reader - write 1 to set module enable, write 0 has no effect
pub type Lcdc1R = crate::BitReader;
///Field `LCDC1` writer - write 1 to set module enable, write 0 has no effect
pub type Lcdc1W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2S1` reader - write 1 to set module enable, write 0 has no effect
...
///Field `EFUSEC` reader - write 1 to set module enable, write 0 has no effect
pub type EfusecR = crate::BitReader;
///Field `EFUSEC` writer - write 1 to set module enable, write 0 has no effect
pub type EfusecW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AES` reader - write 1 to set module enable, write 0 has no effect
pub type AesR = crate::BitReader;
///Field `AES` writer - write 1 to set module enable, write 0 has no effect
pub type AesW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CRC1` reader - write 1 to set module enable, write 0 has no effect
pub type Crc1R = crate::BitReader;
///Field `CRC1` writer - write 1 to set module enable, write 0 has no effect
pub type Crc1W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TRNG` reader - write 1 to set module enable, write 0 has no effect
pub type TrngR = crate::BitReader;
///Field `TRNG` writer - write 1 to set module enable, write 0 has no effect
pub type TrngW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GPTIM1` reader - write 1 to set module enable, write 0 has no effect
pub type Gptim1R = crate::BitReader;
///Field `GPTIM1` writer - write 1 to set module enable, write 0 has no effect
pub type Gptim1W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GPTIM2` reader - write 1 to set module enable, write 0 has no effect
pub type Gptim2R = crate::BitReader;
///Field `GPTIM2` writer - write 1 to set module enable, write 0 has no effect
pub type Gptim2W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BTIM1` reader - write 1 to set module enable, write 0 has no effect
pub type Btim1R = crate::BitReader;
///Field `BTIM1` writer - write 1 to set module enable, write 0 has no effect
pub type Btim1W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BTIM2` reader - write 1 to set module enable, write 0 has no effect
...
///Field `SPI2` reader - write 1 to set module enable, write 0 has no effect
pub type Spi2R = crate::BitReader;
///Field `SPI2` writer - write 1 to set module enable, write 0 has no effect
pub type Spi2W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EXTDMA` reader - write 1 to set module enable, write 0 has no effect
pub type ExtdmaR = crate::BitReader;
///Field `EXTDMA` writer - write 1 to set module enable, write 0 has no effect
pub type ExtdmaW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SECU1` reader - write 1 to set module enable, write 0 has no effect
...
///Field `I2C2` reader - write 1 to set module enable, write 0 has no effect
...
impl R {
    ///Bit 0 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    ...
    ///Bit 11 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn efusec(&self) -> EfusecR {
        EfusecR::new(((self.bits >> 11) & 1) != 0)
    }
    ///Bit 12 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn aes(&self) -> AesR {
        AesR::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn crc1(&self) -> Crc1R {
        Crc1R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 14 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    ...
    ///Bit 17 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    ...
    ///Bit 22 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn extdma(&self) -> ExtdmaR {
        ExtdmaR::new(((self.bits >> 22) & 1) != 0)
    }
    ///Bit 23 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    ...
    ///Bit 28 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
...
impl W {
    ///Bit 0 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn dmac1(&mut self) -> Dmac1W<ESR1rs> {
        Dmac1W::new(self, 0)
    }
    ///Bit 1 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn mailbox1(&mut self) -> Mailbox1W<ESR1rs> {
    ...
    ///Bit 4 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn usart2(&mut self) -> Usart2W<ESR1rs> {
        Usart2W::new(self, 4)
    }
    ///Bit 5 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn ezip1(&mut self) -> Ezip1W<ESR1rs> {
        Ezip1W::new(self, 5)
    }
    ///Bit 6 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn epic(&mut self) -> EpicW<ESR1rs> {
        EpicW::new(self, 6)
    }
    ///Bit 7 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn lcdc1(&mut self) -> Lcdc1W<ESR1rs> {
        Lcdc1W::new(self, 7)
    }
    ///Bit 8 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    ...
    ///Bit 10 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn syscfg1(&mut self) -> Syscfg1W<ESR1rs> {
        Syscfg1W::new(self, 10)
    }
    ///Bit 11 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn efusec(&mut self) -> EfusecW<ESR1rs> {
        EfusecW::new(self, 11)
    }
    ///Bit 12 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn aes(&mut self) -> AesW<ESR1rs> {
        AesW::new(self, 12)
    }
    ///Bit 13 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn crc1(&mut self) -> Crc1W<ESR1rs> {
        Crc1W::new(self, 13)
    }
    ///Bit 14 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn trng(&mut self) -> TrngW<ESR1rs> {
        TrngW::new(self, 14)
    }
    ///Bit 15 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn gptim1(&mut self) -> Gptim1W<ESR1rs> {
        Gptim1W::new(self, 15)
    }
    ///Bit 16 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn gptim2(&mut self) -> Gptim2W<ESR1rs> {
        Gptim2W::new(self, 16)
    }
    ///Bit 17 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn btim1(&mut self) -> Btim1W<ESR1rs> {
        Btim1W::new(self, 17)
    }
    ///Bit 18 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    ...
    ///Bit 21 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn spi2(&mut self) -> Spi2W<ESR1rs> {
        Spi2W::new(self, 21)
    }
    ///Bit 22 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn extdma(&mut self) -> ExtdmaW<ESR1rs> {
        ExtdmaW::new(self, 22)
    }
    ///Bit 23 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    ...
    ///Bit 27 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn i2c1(&mut self) -> I2c1W<ESR1rs> {
        I2c1W::new(self, 27)
    }
    ///Bit 28 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    ...
    ///Bit 31 - write 1 to set module enable, write 0 has no effect
    #[inline(always)]
    pub fn ptc1(&mut self) -> Ptc1W<ESR1rs> {
        Ptc1W::new(self, 31)
    }
}
