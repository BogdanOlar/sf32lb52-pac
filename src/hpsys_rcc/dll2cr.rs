///Register `DLL2CR` reader
pub type R = crate::R<DLL2CRrs>;
///Register `DLL2CR` writer
pub type W = crate::W<DLL2CRrs>;
...
impl W {
    ///Bit 0 - 0: dll disabled 1: dll enabled
    #[inline(always)]
    pub fn en(&mut self) -> EnW<DLL2CRrs> {
        EnW::new(self, 0)
    }
    ///Bit 1
    #[inline(always)]
    pub fn sw(&mut self) -> SwW<DLL2CRrs> {
        SwW::new(self, 1)
    }
    ///Bits 2:5 - DLL lock freqency is decided by STG. DLL output frequency is (STG+1)*24MHz e.g. STG=9,DLL output is 240M
    #[inline(always)]
    pub fn stg(&mut self) -> StgW<DLL2CRrs> {
        StgW::new(self, 2)
    }
    ///Bit 6
    #[inline(always)]
    pub fn xtalin_en(&mut self) -> XtalinEnW<DLL2CRrs> {
        XtalinEnW::new(self, 6)
    }
    ///Bit 7
    #[inline(always)]
    pub fn mode48m_en(&mut self) -> Mode48mEnW<DLL2CRrs> {
        Mode48mEnW::new(self, 7)
    }
    ///Bits 8:11
    #[inline(always)]
    pub fn ldo_vref(&mut self) -> LdoVrefW<DLL2CRrs> {
        LdoVrefW::new(self, 8)
    }
    ///Bit 12
    #[inline(always)]
    pub fn in_div2_en(&mut self) -> InDiv2EnW<DLL2CRrs> {
        InDiv2EnW::new(self, 12)
    }
    ///Bit 13 - 0: dll output not divided 1: dll output divided by 2
    #[inline(always)]
    pub fn out_div2_en(&mut self) -> OutDiv2EnW<DLL2CRrs> {
        OutDiv2EnW::new(self, 13)
    }
    ///Bit 14
    #[inline(always)]
    pub fn mcu_prchg_en(&mut self) -> McuPrchgEnW<DLL2CRrs> {
        McuPrchgEnW::new(self, 14)
    }
    ///Bit 15
    #[inline(always)]
    pub fn mcu_prchg(&mut self) -> McuPrchgW<DLL2CRrs> {
        McuPrchgW::new(self, 15)
    }
    ///Bit 16
    #[inline(always)]
    pub fn prchg_en(&mut self) -> PrchgEnW<DLL2CRrs> {
        PrchgEnW::new(self, 16)
    }
    ///Bit 17
    #[inline(always)]
    pub fn prchg_ext(&mut self) -> PrchgExtW<DLL2CRrs> {
        PrchgExtW::new(self, 17)
    }
    ///Bit 18
    #[inline(always)]
    pub fn vst_sel(&mut self) -> VstSelW<DLL2CRrs> {
        VstSelW::new(self, 18)
    }
    ///Bit 19
    #[inline(always)]
    pub fn bypass(&mut self) -> BypassW<DLL2CRrs> {
        BypassW::new(self, 19)
    }
    ///Bit 20
    #[inline(always)]
    pub fn dtest_en(&mut self) -> DtestEnW<DLL2CRrs> {
        DtestEnW::new(self, 20)
    }
    ///Bits 21:24
    #[inline(always)]
    pub fn dtest_tr(&mut self) -> DtestTrW<DLL2CRrs> {
        DtestTrW::new(self, 21)
    }
    ///Bits 25:27
    #[inline(always)]
    pub fn pu_dly(&mut self) -> PuDlyW<DLL2CRrs> {
        PuDlyW::new(self, 25)
    }
    ///Bits 28:30
    #[inline(always)]
    pub fn lock_dly(&mut self) -> LockDlyW<DLL2CRrs> {
        LockDlyW::new(self, 28)
    }
    ///Bit 31 - 0: dll not ready 1: dll ready
    #[inline(always)]
    pub fn ready(&mut self) -> ReadyW<DLL2CRrs> {
        ReadyW::new(self, 31)
    }
}
///DLL2 Control Register
///
///You can [`read`](crate::Reg::read) this register and get [`dll2cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dll2cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct DLL2CRrs;
impl crate::RegisterSpec for DLL2CRrs {
    type Ux = u32;
}
///`read()` method returns [`dll2cr::R`](R) reader structure
impl crate::Readable for DLL2CRrs {}
///`write(|w| ..)` method takes [`dll2cr::W`](W) writer structure
impl crate::Writable for DLL2CRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DLL2CR to value 0
impl crate::Resettable for DLL2CRrs {
