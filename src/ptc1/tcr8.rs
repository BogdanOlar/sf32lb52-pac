///Register `TCR8` reader
pub type R = crate::R<TCR8rs>;
///Register `TCR8` writer
pub type W = crate::W<TCR8rs>;
...
impl W {
    ...
    ///Bits 16:18 - task operation 3'b000: direct write data 3'b100: read then XOR with data and write back 3'b101: read then OR with data and write back 3'b110: read then AND with data and write back 3'b111: read then add with data and write back
    #[inline(always)]
    pub fn op(&mut self) -> OpW<TCR8rs> {
        OpW::new(self, 16)
    }
    ///Bit 19 - trigger polarity 0: select positive edge of trigger 1: select negative edge of trigger
    #[inline(always)]
    pub fn trigpol(&mut self) -> TrigpolW<TCR8rs> {
        TrigpolW::new(self, 19)
    }
    ///Bit 20 - software trigger task will be triggerd at once after SWTRIG set. SWTRIG will be cleared automatically.
    #[inline(always)]
    pub fn swtrig(&mut self) -> SwtrigW<TCR8rs> {
        SwtrigW::new(self, 20)
    }
    ///Bit 21 - repetition enable 0: task will be triggerd no matter what value REP is 1: task will only be triggerd when REP is not 0
    #[inline(always)]
    pub fn repen(&mut self) -> RepenW<TCR8rs> {
        RepenW::new(self, 21)
    }
    ///Bit 22 - repetition trigger 0: ptc trigger will be generated after each operation 1: ptc trigger will be generated after operation for REP times
    #[inline(always)]
    pub fn reptrig(&mut self) -> ReptrigW<TCR8rs> {
...
///
///
///You can [`read`](crate::Reg::read) this register and get [`tcr8::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tcr8::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct TCR8rs;
impl crate::RegisterSpec for TCR8rs {
    type Ux = u32;
}
///`read()` method returns [`tcr8::R`](R) reader structure
impl crate::Readable for TCR8rs {}
///`write(|w| ..)` method takes [`tcr8::W`](W) writer structure
impl crate::Writable for TCR8rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TCR8 to value 0
impl crate::Resettable for TCR8rs {
