///Register `RCR6` reader
pub type R = crate::R<RCR6rs>;
///Register `RCR6` writer
pub type W = crate::W<RCR6rs>;
...
impl W {
    ///Bits 0:9 - Repetition counter value if REPEN is 1, task will only be triggerd when REP is not 0. when REP is larger than 0, it will be decrease by 1 automatically each time task triggered.
    #[inline(always)]
    pub fn rep(&mut self) -> RepW<RCR6rs> {
        RepW::new(self, 0)
    }
    ///Bits 10:31
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<RCR6rs> {
        RsvdW::new(self, 10)
    }
}
///task 6 repetition counter register
///
///You can [`read`](crate::Reg::read) this register and get [`rcr6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcr6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct RCR6rs;
impl crate::RegisterSpec for RCR6rs {
    type Ux = u32;
}
///`read()` method returns [`rcr6::R`](R) reader structure
impl crate::Readable for RCR6rs {}
///`write(|w| ..)` method takes [`rcr6::W`](W) writer structure
impl crate::Writable for RCR6rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RCR6 to value 0
impl crate::Resettable for RCR6rs {
