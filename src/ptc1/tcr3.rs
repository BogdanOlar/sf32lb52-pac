///Register `TCR3` reader
pub type R = crate::R<TCR3rs>;
///Register `TCR3` writer
pub type W = crate::W<TCR3rs>;
...
impl W {
    ///Bits 0:7 - select trigger source
    #[inline(always)]
    pub fn trigsel(&mut self) -> TrigselW<TCR3rs> {
        TrigselW::new(self, 0)
    }
    ///Bits 8:15
    #[inline(always)]
    pub fn rsvd2(&mut self) -> Rsvd2W<TCR3rs> {
        Rsvd2W::new(self, 8)
    }
    ///Bits 16:18 - task operation 3'b000: direct write data 3'b100: read then XOR with data and write back 3'b101: read then OR with data and write back 3'b110: read then AND with data and write back 3'b111: read then add with data and write back
    #[inline(always)]
    pub fn op(&mut self) -> OpW<TCR3rs> {
        OpW::new(self, 16)
    }
    ///Bit 19 - trigger polarity 0: select positive edge of trigger 1: select negative edge of trigger
    #[inline(always)]
    pub fn trigpol(&mut self) -> TrigpolW<TCR3rs> {
        TrigpolW::new(self, 19)
    }
    ///Bit 20 - software trigger task will be triggerd at once after SWTRIG set. SWTRIG will be cleared automatically.
    #[inline(always)]
    pub fn swtrig(&mut self) -> SwtrigW<TCR3rs> {
        SwtrigW::new(self, 20)
    }
    ///Bit 21 - repetition enable 0: task will be triggerd no matter what value REP is 1: task will only be triggerd when REP is not 0
    #[inline(always)]
    pub fn repen(&mut self) -> RepenW<TCR3rs> {
        RepenW::new(self, 21)
    }
    ///Bit 22 - repetition trigger 0: ptc trigger will be generated after each operation 1: ptc trigger will be generated after operation for REP times
    #[inline(always)]
    pub fn reptrig(&mut self) -> ReptrigW<TCR3rs> {
        ReptrigW::new(self, 22)
    }
    ///Bit 23 - repetition interrupt 0: interrupt will be generated after each operation 1: interrupt will be generated after operation for REP times
    #[inline(always)]
    pub fn repirq(&mut self) -> RepirqW<TCR3rs> {
        RepirqW::new(self, 23)
    }
    ///Bits 24:31
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<TCR3rs> {
        RsvdW::new(self, 24)
    }
}
///
...
pub struct TCR3rs;
impl crate::RegisterSpec for TCR3rs {
    type Ux = u32;
}
///`read()` method returns [`tcr3::R`](R) reader structure
impl crate::Readable for TCR3rs {}
///`write(|w| ..)` method takes [`tcr3::W`](W) writer structure
impl crate::Writable for TCR3rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TCR3 to value 0
impl crate::Resettable for TCR3rs {
