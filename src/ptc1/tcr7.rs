///Register `TCR7` reader
pub type R = crate::R<TCR7rs>;
///Register `TCR7` writer
pub type W = crate::W<TCR7rs>;
///Field `TRIGSEL` reader - select trigger source
...
impl W {
    ///Bits 0:7 - select trigger source
    #[inline(always)]
    pub fn trigsel(&mut self) -> TrigselW<TCR7rs> {
        TrigselW::new(self, 0)
    }
    ///Bits 8:15
    #[inline(always)]
    pub fn rsvd2(&mut self) -> Rsvd2W<TCR7rs> {
        Rsvd2W::new(self, 8)
    }
    ///Bits 16:18 - task operation 3'b000: direct write data 3'b100: read then XOR with data and write back 3'b101: read then OR with data and write back 3'b110: read then AND with data and write back 3'b111: read then add with data and write back
    #[inline(always)]
    pub fn op(&mut self) -> OpW<TCR7rs> {
        OpW::new(self, 16)
    }
    ///Bit 19 - trigger polarity 0: select positive edge of trigger 1: select negative edge of trigger
    #[inline(always)]
    pub fn trigpol(&mut self) -> TrigpolW<TCR7rs> {
        TrigpolW::new(self, 19)
    }
    ///Bit 20 - software trigger task will be triggerd at once after SWTRIG set. SWTRIG will be cleared automatically.
    #[inline(always)]
    pub fn swtrig(&mut self) -> SwtrigW<TCR7rs> {
        SwtrigW::new(self, 20)
    }
    ///Bit 21 - repetition enable 0: task will be triggerd no matter what value REP is 1: task will only be triggerd when REP is not 0
    #[inline(always)]
    pub fn repen(&mut self) -> RepenW<TCR7rs> {
        RepenW::new(self, 21)
    }
    ///Bit 22 - repetition trigger 0: ptc trigger will be generated after each operation 1: ptc trigger will be generated after operation for REP times
    #[inline(always)]
    pub fn reptrig(&mut self) -> ReptrigW<TCR7rs> {
        ReptrigW::new(self, 22)
    }
    ///Bit 23 - repetition interrupt 0: interrupt will be generated after each operation 1: interrupt will be generated after operation for REP times
    #[inline(always)]
    pub fn repirq(&mut self) -> RepirqW<TCR7rs> {
        RepirqW::new(self, 23)
    }
    ///Bits 24:31
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<TCR7rs> {
        RsvdW::new(self, 24)
    }
}
///
///
///You can [`read`](crate::Reg::read) this register and get [`tcr7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tcr7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct TCR7rs;
impl crate::RegisterSpec for TCR7rs {
    type Ux = u32;
}
///`read()` method returns [`tcr7::R`](R) reader structure
impl crate::Readable for TCR7rs {}
///`write(|w| ..)` method takes [`tcr7::W`](W) writer structure
impl crate::Writable for TCR7rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TCR7 to value 0
impl crate::Resettable for TCR7rs {
