///Register `HWCCR` reader
pub type R = crate::R<HWCCRrs>;
///Register `HWCCR` writer
pub type W = crate::W<HWCCRrs>;
///Field `IMODE` reader - This register specifies the format of AHB write command sequence. Refer to CCR1 description
pub type ImodeR = crate::FieldReader;
///Field `IMODE` writer - This register specifies the format of AHB write command sequence. Refer to CCR1 description
...
impl R {
    ///Bits 0:2 - This register specifies the format of AHB write command sequence. Refer to CCR1 description
    #[inline(always)]
...
impl W {
    ///Bits 0:2 - This register specifies the format of AHB write command sequence. Refer to CCR1 description
    #[inline(always)]
    pub fn imode(&mut self) -> ImodeW<HWCCRrs> {
        ImodeW::new(self, 0)
    }
    ///Bits 3:5
    #[inline(always)]
    pub fn admode(&mut self) -> AdmodeW<HWCCRrs> {
        AdmodeW::new(self, 3)
    }
    ///Bits 6:7
    #[inline(always)]
    pub fn adsize(&mut self) -> AdsizeW<HWCCRrs> {
        AdsizeW::new(self, 6)
    }
    ///Bits 8:10
    #[inline(always)]
    pub fn abmode(&mut self) -> AbmodeW<HWCCRrs> {
        AbmodeW::new(self, 8)
    }
    ///Bits 11:12
    #[inline(always)]
    pub fn absize(&mut self) -> AbsizeW<HWCCRrs> {
        AbsizeW::new(self, 11)
    }
    ///Bits 13:17
    #[inline(always)]
    pub fn dcyc(&mut self) -> DcycW<HWCCRrs> {
        DcycW::new(self, 13)
    }
    ///Bits 18:20
    #[inline(always)]
    pub fn dmode(&mut self) -> DmodeW<HWCCRrs> {
        DmodeW::new(self, 18)
    }
    ///Bits 21:31
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<HWCCRrs> {
        RsvdW::new(self, 21)
    }
}
///AHB Write Communication Configuration Register
///
///You can [`read`](crate::Reg::read) this register and get [`hwccr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hwccr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct HWCCRrs;
impl crate::RegisterSpec for HWCCRrs {
    type Ux = u32;
}
///`read()` method returns [`hwccr::R`](R) reader structure
impl crate::Readable for HWCCRrs {}
///`write(|w| ..)` method takes [`hwccr::W`](W) writer structure
impl crate::Writable for HWCCRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets HWCCR to value 0
impl crate::Resettable for HWCCRrs {
