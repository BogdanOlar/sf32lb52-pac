///Register `LAYER0_FILL` reader
pub type R = crate::R<LAYER0_FILLrs>;
///Register `LAYER0_FILL` writer
pub type W = crate::W<LAYER0_FILLrs>;
...
impl W {
    ///Bits 0:7 - background b color
    #[inline(always)]
    pub fn bg_b(&mut self) -> BgBW<LAYER0_FILLrs> {
        BgBW::new(self, 0)
    }
    ///Bits 8:15 - background g color
    #[inline(always)]
    pub fn bg_g(&mut self) -> BgGW<LAYER0_FILLrs> {
        BgGW::new(self, 8)
    }
    ///Bits 16:23 - background r color
    #[inline(always)]
    pub fn bg_r(&mut self) -> BgRW<LAYER0_FILLrs> {
        BgRW::new(self, 16)
    }
    ///Bit 24 - not used
    #[inline(always)]
    pub fn bg_mode(&mut self) -> BgModeW<LAYER0_FILLrs> {
        BgModeW::new(self, 24)
    }
    ///Bit 25 - input 565 data format endian 0: {R\[4:0\], G\[5:3\], G\[2:0\], B\[4:0\]} 1: {G\[2:0\], R\[4:0\], B\[4:0\], G\[5:3\]}
    #[inline(always)]
    pub fn endian(&mut self) -> EndianW<LAYER0_FILLrs> {
        EndianW::new(self, 25)
    }
    ///Bits 26:31
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<LAYER0_FILLrs> {
        RsvdW::new(self, 26)
    }
}
///
///
///You can [`read`](crate::Reg::read) this register and get [`layer0_fill::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`layer0_fill::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct LAYER0_FILLrs;
impl crate::RegisterSpec for LAYER0_FILLrs {
    type Ux = u32;
}
///`read()` method returns [`layer0_fill::R`](R) reader structure
impl crate::Readable for LAYER0_FILLrs {}
///`write(|w| ..)` method takes [`layer0_fill::W`](W) writer structure
impl crate::Writable for LAYER0_FILLrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LAYER0_FILL to value 0
impl crate::Resettable for LAYER0_FILLrs {
