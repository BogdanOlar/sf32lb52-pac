///Register `LAYER0_CONFIG` reader
pub type R = crate::R<LAYER0_CONFIGrs>;
///Register `LAYER0_CONFIG` writer
pub type W = crate::W<LAYER0_CONFIGrs>;
...
impl W {
    ///Bits 0:2 - overlay layer input format 3'h0: RGB565 3'h1: RGB888 3'h2: ARGB8888 3'h3: ARGB8565 3'h4: RGB332 3'h5: A8 3'h6: L8 others: reserved
    #[inline(always)]
    pub fn format(&mut self) -> FormatW<LAYER0_CONFIGrs> {
        FormatW::new(self, 0)
    }
    ///Bit 3 - alpha selection 1'b0: select alpha according to image format 1'b1: select layer alpha
    #[inline(always)]
    pub fn alpha_sel(&mut self) -> AlphaSelW<LAYER0_CONFIGrs> {
        AlphaSelW::new(self, 3)
    }
    ///Bits 4:11 - layer alpha value
    #[inline(always)]
    pub fn alpha(&mut self) -> AlphaW<LAYER0_CONFIGrs> {
        AlphaW::new(self, 4)
    }
    ///Bit 12 - layer color filter enable
    #[inline(always)]
    pub fn filter_en(&mut self) -> FilterEnW<LAYER0_CONFIGrs> {
        FilterEnW::new(self, 12)
    }
    ///Bits 13:25 - source image width(including padding), unit is bytes
    #[inline(always)]
    pub fn width(&mut self) -> WidthW<LAYER0_CONFIGrs> {
        WidthW::new(self, 13)
    }
    ///Bit 26 - preload 64 bytes extra data when reading pixel from memory
    #[inline(always)]
    pub fn prefetch_en(&mut self) -> PrefetchEnW<LAYER0_CONFIGrs> {
        PrefetchEnW::new(self, 26)
    }
    ///Bit 27 - line fetch mode 0: address skip every single line 1: address skip every two line
    #[inline(always)]
    pub fn line_fetch_mode(&mut self) -> LineFetchModeW<LAYER0_CONFIGrs> {
        LineFetchModeW::new(self, 27)
    }
    ///Bit 28 - layer active flag
    #[inline(always)]
    pub fn active(&mut self) -> ActiveW<LAYER0_CONFIGrs> {
        ActiveW::new(self, 28)
    }
    ///Bit 29 - set 1 to enable alpha blending mode. Use layer alpha as blending factor for image with Alpha. Alpha_out = Layer_alpha * Image_alpha
    #[inline(always)]
    pub fn alpha_blend(&mut self) -> AlphaBlendW<LAYER0_CONFIGrs> {
...
///
///
///You can [`read`](crate::Reg::read) this register and get [`layer0_config::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`layer0_config::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct LAYER0_CONFIGrs;
impl crate::RegisterSpec for LAYER0_CONFIGrs {
    type Ux = u32;
}
///`read()` method returns [`layer0_config::R`](R) reader structure
impl crate::Readable for LAYER0_CONFIGrs {}
///`write(|w| ..)` method takes [`layer0_config::W`](W) writer structure
impl crate::Writable for LAYER0_CONFIGrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LAYER0_CONFIG to value 0
impl crate::Resettable for LAYER0_CONFIGrs {
