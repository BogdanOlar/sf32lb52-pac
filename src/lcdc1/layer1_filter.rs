///Register `LAYER1_FILTER` reader
pub type R = crate::R<LAYER1_FILTERrs>;
///Register `LAYER1_FILTER` writer
pub type W = crate::W<LAYER1_FILTERrs>;
...
impl W {
    ///Bits 0:7 - filter b color
    #[inline(always)]
    pub fn filter_b(&mut self) -> FilterBW<LAYER1_FILTERrs> {
        FilterBW::new(self, 0)
    }
    ///Bits 8:15 - filter g color
    #[inline(always)]
    pub fn filter_g(&mut self) -> FilterGW<LAYER1_FILTERrs> {
        FilterGW::new(self, 8)
    }
    ///Bits 16:23 - filter r color
    #[inline(always)]
    pub fn filter_r(&mut self) -> FilterRW<LAYER1_FILTERrs> {
        FilterRW::new(self, 16)
    }
    ///Bits 24:31 - layer color filter mask
    #[inline(always)]
    pub fn filter_mask(&mut self) -> FilterMaskW<LAYER1_FILTERrs> {
        FilterMaskW::new(self, 24)
    }
}
///
///
///You can [`read`](crate::Reg::read) this register and get [`layer1_filter::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`layer1_filter::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct LAYER1_FILTERrs;
impl crate::RegisterSpec for LAYER1_FILTERrs {
    type Ux = u32;
}
///`read()` method returns [`layer1_filter::R`](R) reader structure
impl crate::Readable for LAYER1_FILTERrs {}
///`write(|w| ..)` method takes [`layer1_filter::W`](W) writer structure
impl crate::Writable for LAYER1_FILTERrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LAYER1_FILTER to value 0
impl crate::Resettable for LAYER1_FILTERrs {
