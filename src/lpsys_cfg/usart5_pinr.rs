...
impl W {
    ...
    ///Bits 3:7
    #[inline(always)]
    pub fn rsvd4(&mut self) -> Rsvd4W<USART5_PINRrs> {
        Rsvd4W::new(self, 3)
    }
    ///Bits 8:10 - Connect function pin to selected IO(PB). 0 to 3 for PB00 to PB03. Other values for floating.
    #[inline(always)]
    ...
    ///Bits 11:15
    #[inline(always)]
    pub fn rsvd3(&mut self) -> Rsvd3W<USART5_PINRrs> {
        Rsvd3W::new(self, 11)
    }
    ///Bits 16:18 - Connect function pin to selected IO(PB). 0 to 3 for PB00 to PB03. Other values for floating.
    #[inline(always)]
    ...
    ///Bits 19:23
    #[inline(always)]
    pub fn rsvd2(&mut self) -> Rsvd2W<USART5_PINRrs> {
        Rsvd2W::new(self, 19)
    }
    ///Bits 24:26 - Connect function pin to selected IO(PB). 0 to 3 for PB00 to PB03. Other values for floating.
    #[inline(always)]
    ...
    ///Bits 27:31
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<USART5_PINRrs> {
        RsvdW::new(self, 27)
    }
}
///USART5 Pin Register
