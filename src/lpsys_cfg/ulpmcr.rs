...
///Field `RAM_RDY` reader - reserved for debug
pub type RamRdyR = crate::BitReader;
///Field `RAM_RDY` writer - reserved for debug
pub type RamRdyW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    pub fn rsvd3(&self) -> Rsvd3R {
        Rsvd3R::new(((self.bits >> 13) & 3) as u8)
    }
    ///Bit 15 - reserved for debug
    #[inline(always)]
    pub fn ram_rdy(&self) -> RamRdyR {
        RamRdyR::new(((self.bits >> 15) & 1) != 0)
    }
...
impl W {
    ...
    ///Bit 15 - reserved for debug
    #[inline(always)]
    pub fn ram_rdy(&mut self) -> RamRdyW<ULPMCRrs> {
        RamRdyW::new(self, 15)
    }
    ///Bits 16:17 - reserved for debug
    #[inline(always)]
