...
pub type R = crate::R<CBSR3rs>;
///Register `CBSR3` writer
pub type W = crate::W<CBSR3rs>;
...
impl W {
    ///Bits 0:7 - burst size in non-m2m mode When BS>1, DMA will transfer for BS times for each request if left NDT is larger than BS, or else transfer for left NDT times. When BS=0 or 1, DMA will always do single transfer for each request. In memory-to-memory mode, BS is ignored.
    #[inline(always)]
    pub fn bs(&mut self) -> BsW<CBSR3rs> {
        BsW::new(self, 0)
    }
    ///Bits 8:31
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<CBSR3rs> {
        RsvdW::new(self, 8)
    }
}
///
///
///You can [`read`](crate::Reg::read) this register and get [`cbsr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cbsr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct CBSR3rs;
impl crate::RegisterSpec for CBSR3rs {
    type Ux = u32;
}
///`read()` method returns [`cbsr3::R`](R) reader structure
impl crate::Readable for CBSR3rs {}
///`write(|w| ..)` method takes [`cbsr3::W`](W) writer structure
impl crate::Writable for CBSR3rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CBSR3 to value 0
impl crate::Resettable for CBSR3rs {
