...
pub type R = crate::R<AUDIO_SERIAL_TIMINGrs>;
///Register `AUDIO_SERIAL_TIMING` writer
pub type W = crate::W<AUDIO_SERIAL_TIMINGrs>;
...
impl R {
    ...
    ///Bit 2 - audio code transmit mode select. 0: master mode, 1: slave mode
    #[inline(always)]
    pub fn slave_en(&self) -> SlaveEnR {
        SlaveEnR::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - TX LRCK polarity control. 0: disable TX_LRCK inventor 1: enable TX_LRCK inventor for standard I2S, set tx_lrck_pol to low for Left/Right Justified, set tx_lrck_pol to hgih
    #[inline(always)]
...
impl W {
    ///Bits 0:1 - 00: I2S mode 01: Left justified 10: right justified 11: reserved
    #[inline(always)]
    pub fn timing(&mut self) -> TimingW<AUDIO_SERIAL_TIMINGrs> {
        TimingW::new(self, 0)
    }
    ///Bit 2 - audio code transmit mode select. 0: master mode, 1: slave mode
    #[inline(always)]
    pub fn slave_en(&mut self) -> SlaveEnW<AUDIO_SERIAL_TIMINGrs> {
        SlaveEnW::new(self, 2)
    }
    ///Bit 3 - TX LRCK polarity control. 0: disable TX_LRCK inventor 1: enable TX_LRCK inventor for standard I2S, set tx_lrck_pol to low for Left/Right Justified, set tx_lrck_pol to hgih
    #[inline(always)]
...
pub struct AUDIO_SERIAL_TIMINGrs;
impl crate::RegisterSpec for AUDIO_SERIAL_TIMINGrs {
    type Ux = u32;
}
///`read()` method returns [`audio_serial_timing::R`](R) reader structure
impl crate::Readable for AUDIO_SERIAL_TIMINGrs {}
///`write(|w| ..)` method takes [`audio_serial_timing::W`](W) writer structure
impl crate::Writable for AUDIO_SERIAL_TIMINGrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets AUDIO_SERIAL_TIMING to value 0
impl crate::Resettable for AUDIO_SERIAL_TIMINGrs {
