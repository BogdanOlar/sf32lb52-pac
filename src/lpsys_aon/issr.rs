...
///Field `LP2HP_REQ` reader - write 1 to request HPSYS to stay in active mode
pub type Lp2hpReqR = crate::BitReader;
///Field `LP2HP_REQ` writer - write 1 to request HPSYS to stay in active mode
pub type Lp2hpReqW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `HP2LP_REQ` reader - indicate HPSYS request exists
...
///Field `HP_ACTIVE` reader - read 1 indicates HPSYS is active
...
impl R {
    ...
    pub fn lp2hp_req(&self) -> Lp2hpReqR {
        Lp2hpReqR::new((self.bits & 1) != 0)
    }
    ///Bit 1 - indicate HPSYS request exists
    #[inline(always)]
    ...
    pub fn lp_active(&self) -> LpActiveR {
        LpActiveR::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - read 1 indicates HPSYS is active
    #[inline(always)]
