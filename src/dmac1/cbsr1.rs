///Register `CBSR1` reader
pub type R = crate::R<CBSR1rs>;
///Register `CBSR1` writer
pub type W = crate::W<CBSR1rs>;
...
///
///
///You can [`read`](crate::Reg::read) this register and get [`cbsr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cbsr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct CBSR1rs;
impl crate::RegisterSpec for CBSR1rs {
    type Ux = u32;
}
///`read()` method returns [`cbsr1::R`](R) reader structure
impl crate::Readable for CBSR1rs {}
///`write(|w| ..)` method takes [`cbsr1::W`](W) writer structure
impl crate::Writable for CBSR1rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CBSR1 to value 0
impl crate::Resettable for CBSR1rs {
