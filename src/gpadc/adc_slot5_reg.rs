///Register `ADC_SLOT5_REG` reader
pub type R = crate::R<ADC_SLOT5_REGrs>;
///Register `ADC_SLOT5_REG` writer
pub type W = crate::W<ADC_SLOT5_REGrs>;
...
///
///You can [`read`](crate::Reg::read) this register and get [`adc_slot5_reg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adc_slot5_reg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct ADC_SLOT5_REGrs;
impl crate::RegisterSpec for ADC_SLOT5_REGrs {
    type Ux = u32;
}
///`read()` method returns [`adc_slot5_reg::R`](R) reader structure
impl crate::Readable for ADC_SLOT5_REGrs {}
///`write(|w| ..)` method takes [`adc_slot5_reg::W`](W) writer structure
impl crate::Writable for ADC_SLOT5_REGrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ADC_SLOT5_REG to value 0x0002_0801
impl crate::Resettable for ADC_SLOT5_REGrs {
