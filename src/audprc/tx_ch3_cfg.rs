///Register `TX_CH3_CFG` reader
pub type R = crate::R<TX_CH3_CFGrs>;
///Register `TX_CH3_CFG` writer
pub type W = crate::W<TX_CH3_CFGrs>;
...
impl W {
    ///Bit 0 - tx channel 0 enable
    #[inline(always)]
    pub fn enable(&mut self) -> EnableW<TX_CH3_CFGrs> {
        EnableW::new(self, 0)
    }
    ///Bit 1 - tx format 0: 16-bit mode 1: 24-bit mode
    #[inline(always)]
...
///
///
///You can [`read`](crate::Reg::read) this register and get [`tx_ch3_cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tx_ch3_cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct TX_CH3_CFGrs;
impl crate::RegisterSpec for TX_CH3_CFGrs {
    type Ux = u32;
}
///`read()` method returns [`tx_ch3_cfg::R`](R) reader structure
impl crate::Readable for TX_CH3_CFGrs {}
///`write(|w| ..)` method takes [`tx_ch3_cfg::W`](W) writer structure
impl crate::Writable for TX_CH3_CFGrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TX_CH3_CFG to value 0
impl crate::Resettable for TX_CH3_CFGrs {
