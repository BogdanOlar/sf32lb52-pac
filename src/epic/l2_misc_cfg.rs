///Register `L2_MISC_CFG` reader
pub type R = crate::R<L2_MISC_CFGrs>;
///Register `L2_MISC_CFG` writer
pub type W = crate::W<L2_MISC_CFGrs>;
///Field `CLUT_SEL` reader - L2 CLUT select: 1'h1: select pallette1 1'h0: select pallette0
pub type ClutSelR = crate::BitReader;
///Field `CLUT_SEL` writer - L2 CLUT select: 1'h1: select pallette1 1'h0: select pallette0
...
impl R {
    ///Bit 0 - L2 CLUT select: 1'h1: select pallette1 1'h0: select pallette0
    #[inline(always)]
...
impl W {
    ///Bit 0 - L2 CLUT select: 1'h1: select pallette1 1'h0: select pallette0
    #[inline(always)]
    pub fn clut_sel(&mut self) -> ClutSelW<L2_MISC_CFGrs> {
        ClutSelW::new(self, 0)
    }
    ///Bit 1 - vertical mirror enable
    #[inline(always)]
    pub fn v_mirror(&mut self) -> VMirrorW<L2_MISC_CFGrs> {
        VMirrorW::new(self, 1)
    }
    ///Bit 2 - horizontal mirror enable
    #[inline(always)]
    pub fn h_mirror(&mut self) -> HMirrorW<L2_MISC_CFGrs> {
        HMirrorW::new(self, 2)
    }
    ///Bits 3:15 - external absolute value of cos. U13.12 format.
    #[inline(always)]
    pub fn cos_force_value(&mut self) -> CosForceValueW<L2_MISC_CFGrs> {
        CosForceValueW::new(self, 3)
    }
    ///Bits 16:28 - external absolute value of sin. U13.12 format.
    #[inline(always)]
    pub fn sin_force_value(&mut self) -> SinForceValueW<L2_MISC_CFGrs> {
        SinForceValueW::new(self, 16)
    }
    ///Bit 29 - force epic use external sin and cos value, quadrant is still calculated from ROT_DEG.
    #[inline(always)]
    pub fn deg_force(&mut self) -> DegForceW<L2_MISC_CFGrs> {
        DegForceW::new(self, 29)
    }
    ///Bits 30:31
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<L2_MISC_CFGrs> {
        RsvdW::new(self, 30)
    }
}
///
///
///You can [`read`](crate::Reg::read) this register and get [`l2_misc_cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`l2_misc_cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct L2_MISC_CFGrs;
impl crate::RegisterSpec for L2_MISC_CFGrs {
    type Ux = u32;
}
///`read()` method returns [`l2_misc_cfg::R`](R) reader structure
impl crate::Readable for L2_MISC_CFGrs {}
///`write(|w| ..)` method takes [`l2_misc_cfg::W`](W) writer structure
impl crate::Writable for L2_MISC_CFGrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets L2_MISC_CFG to value 0
impl crate::Resettable for L2_MISC_CFGrs {
