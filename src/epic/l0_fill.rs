///Register `L0_FILL` reader
pub type R = crate::R<L0_FILLrs>;
///Register `L0_FILL` writer
pub type W = crate::W<L0_FILLrs>;
...
impl W {
    ///Bits 0:7 - background b color
    #[inline(always)]
    pub fn bg_b(&mut self) -> BgBW<L0_FILLrs> {
        BgBW::new(self, 0)
    }
    ///Bits 8:15 - background g color
    #[inline(always)]
    pub fn bg_g(&mut self) -> BgGW<L0_FILLrs> {
        BgGW::new(self, 8)
    }
    ///Bits 16:23 - background r color
    #[inline(always)]
    pub fn bg_r(&mut self) -> BgRW<L0_FILLrs> {
        BgRW::new(self, 16)
    }
    ///Bit 24 - Not used.
    #[inline(always)]
    pub fn bg_mode(&mut self) -> BgModeW<L0_FILLrs> {
        BgModeW::new(self, 24)
    }
    ///Bit 25 - input 565 data format endian 0: {R\[4:0\], G\[5:3\], G\[2:0\], B\[4:0\]} 1: {G\[2:0\], R\[4:0\], B\[4:0\], G\[5:3\]}
    #[inline(always)]
    pub fn endian(&mut self) -> EndianW<L0_FILLrs> {
        EndianW::new(self, 25)
    }
    ///Bits 26:31
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<L0_FILLrs> {
        RsvdW::new(self, 26)
    }
}
///
///
///You can [`read`](crate::Reg::read) this register and get [`l0_fill::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`l0_fill::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct L0_FILLrs;
impl crate::RegisterSpec for L0_FILLrs {
    type Ux = u32;
}
///`read()` method returns [`l0_fill::R`](R) reader structure
impl crate::Readable for L0_FILLrs {}
///`write(|w| ..)` method takes [`l0_fill::W`](W) writer structure
impl crate::Writable for L0_FILLrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets L0_FILL to value 0
impl crate::Resettable for L0_FILLrs {
