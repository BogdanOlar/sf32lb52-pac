///Register `L2_ROT_M_CFG2` reader
pub type R = crate::R<L2_ROT_M_CFG2rs>;
///Register `L2_ROT_M_CFG2` writer
pub type W = crate::W<L2_ROT_M_CFG2rs>;
...
impl W {
    ///Bits 0:10 - manual mode pivot x, signed value, -1023~1023, -1024 is not supported
    #[inline(always)]
    pub fn m_pivot_x(&mut self) -> MPivotXW<L2_ROT_M_CFG2rs> {
        MPivotXW::new(self, 0)
    }
    ///Bits 11:15
    #[inline(always)]
    pub fn rsvd2(&mut self) -> Rsvd2W<L2_ROT_M_CFG2rs> {
        Rsvd2W::new(self, 11)
    }
    ///Bits 16:26 - manual mode pivot y, signed value, -1023~1023, -1024 is not supported
    #[inline(always)]
    pub fn m_pivot_y(&mut self) -> MPivotYW<L2_ROT_M_CFG2rs> {
        MPivotYW::new(self, 16)
    }
    ///Bits 27:31
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<L2_ROT_M_CFG2rs> {
        RsvdW::new(self, 27)
    }
}
///
///
///You can [`read`](crate::Reg::read) this register and get [`l2_rot_m_cfg2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`l2_rot_m_cfg2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct L2_ROT_M_CFG2rs;
impl crate::RegisterSpec for L2_ROT_M_CFG2rs {
    type Ux = u32;
}
///`read()` method returns [`l2_rot_m_cfg2::R`](R) reader structure
impl crate::Readable for L2_ROT_M_CFG2rs {}
///`write(|w| ..)` method takes [`l2_rot_m_cfg2::W`](W) writer structure
impl crate::Writable for L2_ROT_M_CFG2rs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets L2_ROT_M_CFG2 to value 0
impl crate::Resettable for L2_ROT_M_CFG2rs {
