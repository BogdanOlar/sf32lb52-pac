///Register `VL_FILTER` reader
pub type R = crate::R<VL_FILTERrs>;
///Register `VL_FILTER` writer
pub type W = crate::W<VL_FILTERrs>;
...
impl W {
    ///Bits 0:7 - filter b color
    #[inline(always)]
    pub fn filter_b(&mut self) -> FilterBW<VL_FILTERrs> {
        FilterBW::new(self, 0)
    }
    ///Bits 8:15 - filter g color
    #[inline(always)]
    pub fn filter_g(&mut self) -> FilterGW<VL_FILTERrs> {
        FilterGW::new(self, 8)
    }
    ///Bits 16:23 - filter r color
    #[inline(always)]
    pub fn filter_r(&mut self) -> FilterRW<VL_FILTERrs> {
        FilterRW::new(self, 16)
    }
    ///Bits 24:31 - layer color filter mask
    #[inline(always)]
    pub fn filter_mask(&mut self) -> FilterMaskW<VL_FILTERrs> {
        FilterMaskW::new(self, 24)
    }
}
///
///
///You can [`read`](crate::Reg::read) this register and get [`vl_filter::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`vl_filter::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct VL_FILTERrs;
impl crate::RegisterSpec for VL_FILTERrs {
    type Ux = u32;
}
///`read()` method returns [`vl_filter::R`](R) reader structure
impl crate::Readable for VL_FILTERrs {}
///`write(|w| ..)` method takes [`vl_filter::W`](W) writer structure
impl crate::Writable for VL_FILTERrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets VL_FILTER to value 0
impl crate::Resettable for VL_FILTERrs {
