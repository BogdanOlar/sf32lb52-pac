///Register `L0_CFG` reader
pub type R = crate::R<L0_CFGrs>;
///Register `L0_CFG` writer
pub type W = crate::W<L0_CFGrs>;
///Field `FORMAT` reader - layer input format 4'h0: RGB565 4'h1: RGB888 4'h2: ARGB8888 4'h3: ARGB8565 4'h4: A8 4'h5: A4 4'h6: L8 4'h7: A2
pub type FormatR = crate::FieldReader;
///Field `FORMAT` writer - layer input format 4'h0: RGB565 4'h1: RGB888 4'h2: ARGB8888 4'h3: ARGB8565 4'h4: A8 4'h5: A4 4'h6: L8 4'h7: A2
...
impl R {
    ///Bits 0:3 - layer input format 4'h0: RGB565 4'h1: RGB888 4'h2: ARGB8888 4'h3: ARGB8565 4'h4: A8 4'h5: A4 4'h6: L8 4'h7: A2
    #[inline(always)]
...
impl W {
    ///Bits 0:3 - layer input format 4'h0: RGB565 4'h1: RGB888 4'h2: ARGB8888 4'h3: ARGB8565 4'h4: A8 4'h5: A4 4'h6: L8 4'h7: A2
    #[inline(always)]
    pub fn format(&mut self) -> FormatW<L0_CFGrs> {
        FormatW::new(self, 0)
    }
    ///Bit 4 - alpha selection 1'b0: select alpha according to image format 1'b1: select layer alpha
    #[inline(always)]
    pub fn alpha_sel(&mut self) -> AlphaSelW<L0_CFGrs> {
        AlphaSelW::new(self, 4)
    }
    ///Bits 5:12 - layer alpha value
    #[inline(always)]
    pub fn alpha(&mut self) -> AlphaW<L0_CFGrs> {
        AlphaW::new(self, 5)
    }
    ///Bits 13:14
    #[inline(always)]
    pub fn rsvd(&mut self) -> RsvdW<L0_CFGrs> {
        RsvdW::new(self, 13)
    }
    ///Bit 15 - layer color filter enable
    #[inline(always)]
    pub fn filter_en(&mut self) -> FilterEnW<L0_CFGrs> {
        FilterEnW::new(self, 15)
    }
    ///Bits 16:28 - source image width(including padding), unit is bytes
    #[inline(always)]
    pub fn width(&mut self) -> WidthW<L0_CFGrs> {
        WidthW::new(self, 16)
    }
    ///Bit 29 - preload 64 bytes extra data when reading pixel from memory
    #[inline(always)]
    pub fn prefetch_en(&mut self) -> PrefetchEnW<L0_CFGrs> {
        PrefetchEnW::new(self, 29)
    }
    ///Bit 30 - layer active flag
    #[inline(always)]
    pub fn active(&mut self) -> ActiveW<L0_CFGrs> {
        ActiveW::new(self, 30)
    }
    ///Bit 31 - set 1 to enable alpha blending mode. Use layer alpha as blending factor for image with Alpha. Alpha_out = Layer_alpha * Image_alpha
    #[inline(always)]
    pub fn alpha_blend(&mut self) -> AlphaBlendW<L0_CFGrs> {
        AlphaBlendW::new(self, 31)
    }
}
///
///
///You can [`read`](crate::Reg::read) this register and get [`l0_cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`l0_cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct L0_CFGrs;
impl crate::RegisterSpec for L0_CFGrs {
    type Ux = u32;
}
///`read()` method returns [`l0_cfg::R`](R) reader structure
impl crate::Readable for L0_CFGrs {}
///`write(|w| ..)` method takes [`l0_cfg::W`](W) writer structure
impl crate::Writable for L0_CFGrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets L0_CFG to value 0
impl crate::Resettable for L0_CFGrs {
