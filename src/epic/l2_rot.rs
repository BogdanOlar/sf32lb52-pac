///Register `L2_ROT` reader
pub type R = crate::R<L2_ROTrs>;
///Register `L2_ROT` writer
pub type W = crate::W<L2_ROTrs>;
...
impl W {
    ///Bit 0 - rot_max_col and rot_max_line calculation request. Write 1 to trigger the calculation.
    #[inline(always)]
    pub fn calc_req(&mut self) -> CalcReqW<L2_ROTrs> {
        CalcReqW::new(self, 0)
    }
    ///Bit 1 - rot_max_col and rot_max_line calculation clear request. Write 1 to clear the result.
    #[inline(always)]
    pub fn calc_clr(&mut self) -> CalcClrW<L2_ROTrs> {
        CalcClrW::new(self, 1)
    }
    ///Bits 2:10 - rotation degree, rotation is clockwise.
    #[inline(always)]
    pub fn rot_deg(&mut self) -> RotDegW<L2_ROTrs> {
        RotDegW::new(self, 2)
    }
    ///Bit 11 - calculation done indicator
    #[inline(always)]
...
///
///
///You can [`read`](crate::Reg::read) this register and get [`l2_rot::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`l2_rot::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct L2_ROTrs;
impl crate::RegisterSpec for L2_ROTrs {
    type Ux = u32;
}
///`read()` method returns [`l2_rot::R`](R) reader structure
impl crate::Readable for L2_ROTrs {}
///`write(|w| ..)` method takes [`l2_rot::W`](W) writer structure
impl crate::Writable for L2_ROTrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets L2_ROT to value 0
impl crate::Resettable for L2_ROTrs {
